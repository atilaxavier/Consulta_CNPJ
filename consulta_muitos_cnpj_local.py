...
# Consulta muitos CNPJs em base local SQLITE.
# Considera que temos SQLLITE e API para consulta a base de CNPJs rodando na maquina
# Ref: https://github.com/rictom/cnpj_api

DELAY_PADRAO = 0
TEMPO_ESPERA_BLOQUEIO = 30  # Tempo em segundos para esperar após o erro 429
...
def main():
    ...
    with open(ARQUIVO_ENTRADA, mode="r", encoding="utf-8") as incsv:
        ...
        for linha in leitor:
            ...
            url = f"http://127.0.0.1:8015/cnpj/{cnpj}"
